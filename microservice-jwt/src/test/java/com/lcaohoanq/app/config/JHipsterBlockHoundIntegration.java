...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.lcaohoanq.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.lcaohoanq.app.security.DomainUserDetailsService", "createSpringSecurityUser");
